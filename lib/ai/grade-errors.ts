...
export function clientGradeErrorMessage(reference?: string | null): string {
  const base =
    "We couldn't confirm completion of this mark estimate. Check History before retrying; your answer may already be saved. Retrying the same submission reuses the same request. If processing had already started, this try may count toward today's limit.";
